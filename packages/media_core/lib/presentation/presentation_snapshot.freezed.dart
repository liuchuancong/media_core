...
/// Current presentation mode.
 PresentationMode get mode;/// Current presentation capabilities.
 PresentationCapabilities get capabilities;/// Whether a transition is running.
 bool get transitioning;/// Whether presentation system is enabled.
 bool get enabled;/// Current lifecycle generation.
///
...
int get hashCode {
  final _this = this as PresentationSnapshot;
  return Object.hash(runtimeType,_this.mode,_this.capabilities,_this.transitioning,_this.enabled,_this.generation,_this.error);
}

@override
String toString() {
  final _this = this as PresentationSnapshot;
  return 'PresentationSnapshot(mode: ${_this.mode}, capabilities: ${_this.capabilities}, transitioning: ${_this.transitioning}, enabled: ${_this.enabled}, generation: ${_this.generation}, error: ${_this.error})';
}
...
@useResult
$Res call({
 PresentationMode mode, PresentationCapabilities capabilities, bool transitioning, bool enabled, int generation, String? error
});
...
/// Create a copy of PresentationSnapshot
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mode = null,Object? capabilities = null,Object? transitioning = null,Object? enabled = null,Object? generation = null,Object? error = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PresentationMode mode,  PresentationCapabilities capabilities,  bool transitioning,  bool enabled,  int generation,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PresentationSnapshot() when $default != null:
return $default(_that.mode,_that.capabilities,_that.transitioning,_that.enabled,_that.generation,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PresentationMode mode,  PresentationCapabilities capabilities,  bool transitioning,  bool enabled,  int generation,  String? error)  $default,) {final _that = this;
switch (_that) {
case _PresentationSnapshot():
return $default(_that.mode,_that.capabilities,_that.transitioning,_that.enabled,_that.generation,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PresentationMode mode,  PresentationCapabilities capabilities,  bool transitioning,  bool enabled,  int generation,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _PresentationSnapshot() when $default != null:
return $default(_that.mode,_that.capabilities,_that.transitioning,_that.enabled,_that.generation,_that.error);case _:
  return null;
...
class _PresentationSnapshot extends PresentationSnapshot {
  const _PresentationSnapshot({this.mode = PresentationMode.normal, this.capabilities = const PresentationCapabilities(), this.transitioning = false, this.enabled = true, this.generation = 0, this.error}): super._();
...
@override
int get hashCode {
    return Object.hash(runtimeType,mode,capabilities,transitioning,enabled,generation,error);
}

@override
String toString() {
    return 'PresentationSnapshot(mode: $mode, capabilities: $capabilities, transitioning: $transitioning, enabled: $enabled, generation: $generation, error: $error)';
}
...
/// Create a copy of PresentationSnapshot
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mode = null,Object? capabilities = null,Object? transitioning = null,Object? enabled = null,Object? generation = null,Object? error = freezed,}) {
