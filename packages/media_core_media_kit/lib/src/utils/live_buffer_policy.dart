...
abstract final class LiveBufferPolicy {
  ...
  /// on a box with one or two gigabytes the kernel starts reclaiming
  /// pages against a 96 MB reserve long before a live stream ever fills
  /// it. 40 MB still holds the full [cacheSeconds] window for the ~8
  /// Mbit/s "blu-ray 8M" streams these rooms serve, while the time-based
  /// headroom below — the part that actually fixed stutter — is left
  /// untouched.
