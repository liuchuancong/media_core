...
> 其他语言版本 · Other languages: [English](../en/README.md) · [繁體中文](../zh-Hant/README.md)
...
各模块的职责边界、核心 API 与依赖关系，请参阅上方「模块文档」逐一了解。
...
media_core/
└── docs/
    ├── zh-Hans/         # README.md + 36 个模块文档（简体中文）
    ├── en/              # README.md + 36 个模块文档（English）
    └── zh-Hant/         # README.md + 36 个模块文档（繁體中文）
```
